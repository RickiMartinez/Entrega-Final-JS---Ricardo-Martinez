...
document.getElementById("game").style.borderRadius = "15px";
...
background.src = "images/Sin título.png";
...
function dateBuilder(d) {
  ...
  let months = ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Novienbre", "Diciembre"];
